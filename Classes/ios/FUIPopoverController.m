...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImage *backgroundImage = [[UIImage imageWithColor:backgroundColor cornerRadius:9 size:CGSizeMake(frame.size.width, frame.size.width)] resizableImageWithCapInsets:UIEdgeInsetsMake(CAP_INSET,CAP_INSET,CAP_INSET,CAP_INSET)];
